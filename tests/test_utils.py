from ..sales_taxes.utils import parse_one_line, round_up_tax
...
def test_round_up_tax():
    assert round(round_up_tax(1.10), 2) == 1.10
    assert round(round_up_tax(1.11), 2) == 1.15
    assert round(round_up_tax(1.15), 2) == 1.15
    assert round(round_up_tax(1.16), 2) == 1.20
